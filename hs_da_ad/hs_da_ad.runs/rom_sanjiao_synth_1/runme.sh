...
HD_PWD='E:/FPGA/xianyu/hs_da_ad/hs_da_ad.runs/rom_sanjiao_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_sanjiao.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_sanjiao.tcl
