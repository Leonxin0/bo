...
#
# Generated by export_simulation on Thu Jan 26 14:22:18 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './rom_sanjiao.sh' script.

./rom_sanjiao.sh -reset_run
...
./rom_sanjiao.sh -noclean_files

For more information on the script, please type './rom_sanjiao.sh -help'.
